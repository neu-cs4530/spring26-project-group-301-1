 ...
 * - `getWinner`: given a completed game state, returns the user ID of the winner,
 *   or null in the case of a tie
 */
export interface GameLogic<GameState, GameView> {
  ...
  getWinner: (state: GameState, players: string[]) => string | null;
}
